...
namespace CpuRasterizor
{
	...
	public:
		...
		bool has_mat4x4(const property_name& name) const;
		...
		void set_mat4x4(const property_name& name, const tinymath::mat4x4& val);
		...
		tinymath::mat4x4 get_mat4x4(const property_name& name) const;
