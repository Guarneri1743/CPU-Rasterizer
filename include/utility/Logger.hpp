...
//=========================== Log Marcos ======================================
#define LOG(...) Guarneri::Logger::log_console(Guarneri::Logger::Severity::kLog, __VA_ARGS__)
#define WARN(...) Guarneri::Logger::log_console(Guarneri::Logger::Severity::kWarning, __VA_ARGS__)
#define ERROR(...) Guarneri::Logger::log_console(Guarneri::Logger::Severity::kError, __VA_ARGS__)
